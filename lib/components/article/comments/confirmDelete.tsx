      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <Dialog.Panel className="mx-auto max-w-[420px] w-full bg-base-100 rounded-xl shadow-darklg">
          ...
          <div className="flex flex-col justify-center gap-6 p-6">
            ...
            <button
              className="flex px-6 py-2 items-center justify-center bg-primary text-base-100 transition-colors duration-300 transform border rounded-lg hover:bg-primary w-full"
              onClick={deleteFunc}
            >
              Confirm Delete
            </button>
